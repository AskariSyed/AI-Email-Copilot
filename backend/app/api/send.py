...
from app.models import Email, GmailAccount, Draft
...
def send_email_reply(email_id: int, request: SendEmailRequest, db: Session = Depends(get_db)):
    ...
    try:
        ...
        message['To'] = original_email.reply_to if original_email.reply_to else original_email.sender
