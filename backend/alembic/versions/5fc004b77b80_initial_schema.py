...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_gmail_accounts_id"), "gmail_accounts", ["id"], unique=False
    )
    op.create_table(
        "style_profiles",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_email_threads_gmail_thread_id"),
        "email_threads",
        ["gmail_thread_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_emails_gmail_message_id"), "emails", ["gmail_message_id"], unique=True
    )
